 ...
 *
 * Responsibility:
 * Ensures that only authenticated dark-mode can access specific routes in the application.
 * This component checks the user's authentication state and redirects unauthenticated dark-mode
 * to the login page. It also handles session cleanup using a custom hook.
 *
 * Features:
 * - Redirects unauthenticated dark-mode to the root ("/") route.
 * - Renders child components for authenticated dark-mode using `Outlet`.
...
export default function AuthRequired() {
    ...
    // Renders child components for authenticated dark-mode
    return <Outlet/>
};