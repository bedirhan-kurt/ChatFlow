 ...
 *
 * Responsibility:
 * This component is responsible for rendering the system chat-area UI.
 * It provides a container for displaying system-related chat-area or notifications
 * in a structured and styled format.
 *
 * Features:
 * - Uses a `Card` component as the main container for system chat-area.
